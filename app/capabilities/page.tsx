...
export const metadata: Metadata = pageMetadata({
  ...
  description: "Explore ISTRIADE capabilities across artificial intelligence, decision intelligence, search visibility, web and digital implementation, automation, commerce and content systems.",
  path: "/capabilities/",
});
...
const capabilities = [
  ...
  ["Web & Digital Implementation", "Website development, digital implementation and connected business technology work designed to turn defined requirements into usable online systems."],
  ["Automation & Execution", "Marketing automation, workflow automation, operational orchestration and controlled implementation designed to reduce repetitive work and connect decisions with action."],
...
export default function CapabilitiesPage() {
  return <>
    <PageHero eyebrow="Capabilities" title="Capabilities that connect technology with execution." lead="ISTRIADE develops reusable capabilities across artificial intelligence, decision intelligence, search, web and digital implementation, automation, digital products, commerce and content systems." />
