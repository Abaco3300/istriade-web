...
export default function AboutPage() {
  return <>
    ...
    <section className="section trust-section"><div className="container identity-panel"><p className="eyebrow">Company identity</p><dl><div><dt>Legal name</dt><dd>{site.legalName}</dd></div><div><dt>Jurisdiction</dt><dd>{site.location}</dd></div><div><dt>Operating model</dt><dd>Digital-first</dd></div><div><dt>Official website</dt><dd>istriadegroup.com</dd></div><div><dt>Corporate contact</dt><dd><a href={`mailto:${site.email}`}>{site.email}</a></dd></div></dl></div></section>
  </>;
}
